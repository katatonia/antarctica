...
/* harmony import */ var _modules_sidebar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/sidebar */ "./js/modules/sidebar.js");
/* harmony import */ var _modules_form__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/form */ "./js/modules/form.js");
/* harmony import */ var _modules_scroll_to__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/scroll-to */ "./js/modules/scroll-to.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  Object(_modules_sidebar__WEBPACK_IMPORTED_MODULE_2__["showSidebar"])();
  Object(_modules_form__WEBPACK_IMPORTED_MODULE_3__["onFormSubmit"])();
  Object(_modules_scroll_to__WEBPACK_IMPORTED_MODULE_4__["scrollOnMenuBtn"])();
...
var getFormInputs = function getFormInputs() {
  var inputName = form.querySelector('input[name="Имя"]');
  var inputPhone = form.querySelector('input[name="Телефон"]');
...
/***/ "./js/modules/scroll-to.js":
/*!*********************************!*\
  !*** ./js/modules/scroll-to.js ***!
  \*********************************/
/*! exports provided: scrollOnMenuBtn, scrollToBlock */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "scrollOnMenuBtn", function() { return scrollOnMenuBtn; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "scrollToBlock", function() { return scrollToBlock; });
var features = document.querySelector('.features');
var catalog = document.querySelector('.catalog');
var contacts = document.querySelector('.contacts');
var featuresBtn = document.querySelector('.menu__list-item--features');
var catalogBtn = document.querySelector('.menu__list-item--catalog');
var contactsBtn = document.querySelector('.menu__list-item--contacts');
...
var scrollToBlock = function scrollToBlock(btn, block) {
  if (block) {
...
var scrollOnMenuBtn = function scrollOnMenuBtn() {
...
var burger = header.querySelector('.menu__toggle');
var sidebar = document.querySelector('.sidebar');
var aside = sidebar.querySelector('.sidebar__aside');
var iconClose = sidebar.querySelector('.sidebar__toggle');
var mainContainer = document.querySelector('.main__container');
var noJsArrow = document.querySelectorAll('.no-js');
...
var showSidebar = function showSidebar() {
  if (burger) {
    removeClass(Object(_utils_util__WEBPACK_IMPORTED_MODULE_0__["createElementsArrow"])(noJsArrow));
...
/*!**************************!*\
  !*** ./js/utils/util.js ***!
  \**************************/
/*! exports provided: createElementsArrow */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createElementsArrow", function() { return createElementsArrow; });
var createElementsArrow = function createElementsArrow(arr) {
  var elementsArr = [];
